...
* Path to your Trac install (https://your.trac.server.com/)
...
* Clone into your plugins dir: git clone git://github.com/hamletmun/redmine_trac_custom_field.git
...
Rake to remove plugin: rake redmine:plugins:migrate NAME=redmine_trac_custom_field VERSION=0 RAILS_ENV=production
